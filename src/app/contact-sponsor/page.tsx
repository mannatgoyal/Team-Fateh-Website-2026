            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Become a sponsor and be part of our journey to engineer the future of mobility. Let's discuss a partnership that builds champions.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-3xl shadow-lg border border-slate-100 relative overflow-hidden transition-all duration-500">
                        ...
                        <h3 className="text-2xl font-bold mb-8 text-secondary relative z-10">Sponsorship Inquiry</h3>

                        <form ref={formRef} onSubmit={sendEmail} className="space-y-6 relative z-10">
                            {status === "success" && (
                                <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center gap-3">
                                    <CheckCircle2 size={20} className="text-green-500 shrink-0" />
                                    <p className="text-sm font-medium">Message sent successfully! Our partnership team will contact you soon.</p>
                                </div>
                            )}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">Partnership Proposal / Message</label>
                                <textarea
                                    required
                                    rows={4}
                                    name="message"
                                    ...
                                    placeholder="Let us know how your company would like to support Team Fateh..."
                                ></textarea>
                            </div>
